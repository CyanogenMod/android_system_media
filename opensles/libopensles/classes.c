...
static const struct iid_vtable AudioPlayer_interfaces[INTERFACES_AudioPlayer] = {
    ...
    {MPH_METADATAEXTRACTION, INTERFACE_DYNAMIC_GAME_MUSIC, offsetof(CAudioPlayer, mMetadataExtraction)},
    {MPH_METADATATRAVERSAL, INTERFACE_DYNAMIC_GAME_MUSIC, offsetof(CAudioPlayer, mMetadataTraversal)},
    ...
    {MPH_ENVIRONMENTALREVERB, INTERFACE_DYNAMIC_OPTIONAL, offsetof(CAudioPlayer, mEnvironmentalReverb)},
...
static const struct iid_vtable MidiPlayer_interfaces[INTERFACES_MidiPlayer] = {
    ...
    {MPH_ENVIRONMENTALREVERB, INTERFACE_DYNAMIC_OPTIONAL, offsetof(CMidiPlayer, mEnvironmentalReverb)},
