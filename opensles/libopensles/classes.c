...
#ifdef ANDROID
    // FIXME The only reason this is implicit is because Android audio player assumes the prefetch
    // interface is initialized even if not requested, see android_prefetchEventCallback
